...
#	define TRACE_STREAMER_EXPAND(args)                                                                                         \
		args[0], args[1], args[2], args[3], args[4], args[5], args[6], args[7], args[8], args[9], args[10], args[11], args[12], \
			args[13], args[14], args[15], args[16], args[17], args[18], args[19], args[20], args[21], args[22], args[23],       \
			args[24], args[25], args[26], args[27], args[28], args[29], args[30], args[31], args[32], args[33], args[34]
...
static void vmftrace_user(struct timeval*, int TID, uint8_t lvl, const char* insert, const char* file, int line, uint16_t nargs,
...
SUPPRESS_NOT_USED_WARN
static void mftrace_user(struct timeval* tvp, int TID, uint8_t lvl, const char* insert, const char* file, int line, uint16_t nargs,
						 const char* msg, ...)
{
	va_list ap;
	va_start(ap, msg);
...
#	endif
	...
	{
		if (f == (std::basic_ostream<char> & (*)(std::basic_ostream<char>&)) & std::endl) { msg+= "\n"; }
		return *this;
	}
