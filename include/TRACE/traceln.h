...
#	endif
static void
vlntrace_user(struct timeval *tvp, int TID __attribute__((__unused__)), uint8_t lvl, const char *insert, const char *file, int line,
			  const char *function __attribute__((__unused__)), uint16_t nargs, const char *msg, va_list ap)
{
...
static void lntrace_user(struct timeval *tvp, int TID, uint8_t lvl, const char *insert, const char *file, int line,
